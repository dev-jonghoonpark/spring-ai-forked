...
package org.springframework.ai.gemini.acme;
...
public class AcmeIT extends AbstractIT {
	...
	@Autowired
	private GeminiChatModel chatModel;
	...
	void acmeChain() {
		...
		// Create the prompt ad-hoc for now, need to put in system content and user
		// content via ChatPromptTemplate or some other content building mechanic;
