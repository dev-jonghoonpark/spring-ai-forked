...
package org.springframework.ai.gemini.metadata.support;
...
import org.springframework.ai.gemini.metadata.GeminiRateLimit;
import org.springframework.http.ResponseEntity;
import org.springframework.util.Assert;
import org.springframework.util.CollectionUtils;
import org.springframework.util.StringUtils;

import static org.springframework.ai.gemini.metadata.support.GeminiApiResponseHeaders.REQUESTS_LIMIT_HEADER;
import static org.springframework.ai.gemini.metadata.support.GeminiApiResponseHeaders.REQUESTS_REMAINING_HEADER;
import static org.springframework.ai.gemini.metadata.support.GeminiApiResponseHeaders.REQUESTS_RESET_HEADER;
import static org.springframework.ai.gemini.metadata.support.GeminiApiResponseHeaders.TOKENS_LIMIT_HEADER;
import static org.springframework.ai.gemini.metadata.support.GeminiApiResponseHeaders.TOKENS_REMAINING_HEADER;
import static org.springframework.ai.gemini.metadata.support.GeminiApiResponseHeaders.TOKENS_RESET_HEADER;

/**
 * Utility used to extract known HTTP response headers for the {@literal Gemini} API.
 *
 * @author Jonghoon Park
 */
public final class GeminiResponseHeaderExtractor {

	private static final Logger logger = LoggerFactory.getLogger(GeminiResponseHeaderExtractor.class);

	private GeminiResponseHeaderExtractor() {
	...
	public static RateLimit extractAiResponseHeaders(ResponseEntity<?> response) {
		...
		return new GeminiRateLimit(requestsLimit, requestsRemaining, requestsReset, tokensLimit, tokensRemaining,
				tokensReset);
	}
