...
/**
 * {@link Enum Enumeration} of {@literal Gemini} API response headers.
 *
 * @author Jonghoon Park
 */
public enum GeminiApiResponseHeaders {
	...
	GeminiApiResponseHeaders(String headerName, String description) {
