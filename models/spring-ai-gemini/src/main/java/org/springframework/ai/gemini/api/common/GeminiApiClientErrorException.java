 ...
 */
public class GeminiApiClientErrorException extends RuntimeException {

	public GeminiApiClientErrorException(String message) {
		super(message);
	}

	public GeminiApiClientErrorException(String message, Throwable cause) {
		super(message, cause);
	}
