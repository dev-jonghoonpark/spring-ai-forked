 ...
 *
 * References: <a href=
 * "https://platform.openai.com/docs/api-reference/chat/create#chat-create-response_format">Gemini
...
public class ResponseFormat {
	...
	public enum Type {
		...
		/**
		 * Enables JSON mode, which guarantees the content the model generates is valid
		 * JSON.
		 */
